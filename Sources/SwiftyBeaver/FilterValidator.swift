...
struct FilterValidator {
    ...
    private static func filterMatchesCondition(_ filter: FilterType, level: LogsViewer.Level,
    ...
    private static func filterMatchesMinLogLevel(_ filter: FilterType, level: LogsViewer.Level) -> Bool {
