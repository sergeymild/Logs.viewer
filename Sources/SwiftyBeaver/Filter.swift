...
public protocol FilterType : class {
    ...
    func reachedMinLevel(_ level: LogsViewer.Level) -> Bool
}
...
public class Filter {
    ...
    let required: Bool
    let minLevel: LogsViewer.Level

    public init(_ target: Filter.TargetType, required: Bool, minLevel: LogsViewer.Level) {
    ...
    public func reachedMinLevel(_ level: LogsViewer.Level) -> Bool {
...
public class CompareFilter: Filter, FilterType {
    ...
    override public init(_ target: Filter.TargetType, required: Bool, minLevel: LogsViewer.Level) {
...
public class FunctionFilterFactory {
    public static func startsWith(_ prefixes: String..., caseSensitive: Bool = false,
                                  required: Bool = false, minLevel: LogsViewer.Level = .verbose) -> FilterType {
    ...
    public static func custom(required: Bool = false, minLevel: LogsViewer.Level = .verbose, filterPredicate: @escaping (String) -> Bool) -> FilterType {
